...
if strcmp(compiler,'gcc') 
    if linux || mac
       ...
       %path_to_compiler_libraries='/Applications/Xcode.app/Contents/Developer/usr/lib/llvm-gcc/4.2.1/';
       %path_to_compiler='/Applications/Xcode.app/Contents/Developer/usr/bin/';
       path_to_compiler_libraries='/usr/lib/';
