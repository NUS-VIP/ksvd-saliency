...
p.blurfrac = 0.0;                % final blur to apply to master saliency map
...
p.channels = 'DIOA';               % feature channels to use encoded as a string
                                  % these are available:
                                  %   C is for Color
                                  %   I is for Intensity
...
p.ittiblurfrac = 0.0;            % apply final blur to master saliency map
